        ...
        $(document).ready(function () {
            ...
            $('.range_allowance').DataTable({
                ...
                buttons: [{
                        ...
                        bold: 'true',
                        fontSize: '15',
                        title: 'Daphne Lord School (Report section Salary)',
...
<body>
  ...
  ?>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Report section Salary</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="">Administrator Hub</a></li>
                    <li class="breadcrumb-item active">Report section Salary</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                            ...
                            <table id="example" class="range_allowance table display table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                                        ...
                                                        $result173 = $myActivityTech->selectMyActivity_forAdimn_report($mysqli);
                                                        $count = 0;
