        ...
        $(document).ready(function () {
            ...
            $('.range_allowance').DataTable({
                ...
                buttons: [{
                        ...
                        bold: 'true',
                        fontSize: '15',
                        title: 'Daphne Collage (salary Range Information)',
  ...
  ?>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Drop Down</a></li>
                    ...
                    <div class="card info-card sales-card">
                        <div class="card-body">
                            <table id="example" class="range_allowance table display table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                                            $scheds3 = $_SESSION['emp'];
                                                            // Output employees data
                                                            $myActivityTech = new myActivityTech();
                                                            $result173 = $myActivityTech->selectMyActivity($mysqli, $scheds3);
                                                        $count = 0;
